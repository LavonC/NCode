...
- Configure CMAKE in Project Folder using "cmake -B build -G Ninja -DCMAKE_TOOLCHAIN_FILE={PATH TO PARENT FOLDER OF VCPKG}/VCPKG/vcpkg/scripts/buildsystems/vcpkg.cmake -DGGML_VULKAN"
